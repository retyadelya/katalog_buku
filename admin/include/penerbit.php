...
if(isset($_GET['aksi'])&&(isset($_POST['katakunci']))){
  if($_GET['aksi']='cari' && !empty($_POST['katakunci'])){
    ...
    $katakunci_penerbit = $_SESSION['katakunci'];
  }
}
...
$sql_k .= " ORDER BY penerbit limit $posisi, $batas ";
    ...
    <tr>
       ...
       <a href="index.php?include=detail-penerbit&data=<?php echo $id_penerbit;?>" class="btn btn-xs btn-info" name="detail" value="detail" title="Detail"><i class="fas fa-eye"></i></a>
    ...
    if($jum_halaman==0){
       ...
       if (isset($_GET["katakunci"])){
           ...
           if($halaman!=1){
              ...
              <a class='page-link' 
              href='index.php?include=penerbit&katakunci=$katakunci_penerbit
           ...
           for($i=1; $i<=$jum_halaman; $i++){
            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
               if($i!=$halaman){
                  echo "<li class='page-item'><a class='page-link' 
                  href='index.php?include=penerbit&katakunci
                  =$katakunci_penerbit&halaman=$i'>
                  $i</a></li>";
               }else{
                  echo "<li class='page-item'>
            ...
            if($halaman!=$jum_halaman){
               ...
               echo "<li class='page-item'><a class='page-link' 
               href='index.php?include=penerbit&katakunci=
               $katakunci_penerbit&halaman=$jum_halaman'>
               Last</a></li>";
            }
        }else{
          if($halaman!=1){
             ...
             echo "<li class='page-item'><a class='page-link' 
             href='index.php?include=penerbit&
           ...
           for($i=1; $i<=$jum_halaman; $i++){
            ...
            if($halaman!=$jum_halaman){
               echo "<li class='page-item'><a class='page-link' 
               href='index.php?include=penerbit&halaman=$setelah'>
               »</a></li>";
               echo "<li class='page-item'><a class='page-link' 
               href='index.php?include=penerbit&
