        ...
        <?php }}?>
              ...
              <ul class="pagination pagination-sm m-0 float-right">
                ...
                if($halaman!=1){
                  ...
                  <a class='page-link' href='kategoriblog.php?halaman=1'>
                  First</a></li>";
                  echo "<li class='page-item'>
                  <a class='page-link' href='kategoriblog.php?halaman=$sebelum'>
                  «</a></li>";
                }
                for($i=1; $i<=$jum_halaman; $i++){
                    if($i!=$halaman){
                      echo "<li class='page-item'>
                      <a class='page-link' href='kategoriblog.php?halaman=$i'>
                      $i</a></li>";
                    }else{
                        echo "<li class='page-item'>
                ...
                if($halaman!=$jum_halaman){
                    echo "<li class='page-item'>
                    <a class='page-link' href='kategoriblog.php?halaman=$setelah'>
                    »</a></li>";
                    echo "<li class='page-item'>
                    <a class='page-link' href='kategoriblog.php?halaman=
                    $jum_halaman'>
                    Last</a></li>";
                }
                }?>
